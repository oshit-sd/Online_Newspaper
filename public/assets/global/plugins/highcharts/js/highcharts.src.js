...
/**
 * Returns true if the object is not null or undefined. Likes MooTools' $.defined.
 * @param {Object} obj
 */
...
/**
 * Check if an element is an array, and if not, make it into an array. Likes
 * MooTools' $.splat.
 */
function splat(obj) {
...
/**
 * Return the first value that is defined. Likes MooTools' $.pick.
 */
