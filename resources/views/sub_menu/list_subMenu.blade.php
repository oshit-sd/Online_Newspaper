    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <a href="/SubMenu/create" style="font-weight: bold; border-bottom: 1px solid">Add Sub Menu</a> |
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-left" role="menu">
                                        <li>
                                            <a href="{{ '/SubMenu/'.$data->id.'/edit' }}">
                                            <i class="btn btn-primary btn-sm">Edit</i>  </a>
                                        </li>
                                        <li><a href="">
                                            {!! Form::open(['url' => '/SubMenu/'.$data->id , 'method' => 'DELETE']) !!}
