...
<div class="politicsContent">
    <div class="politics"> <span class="pt_head"> বিনোদন </span></div>
    @foreach($enter as $rn)
    ...
    <div class="col-md-3 col-sm-3" >
        <div class="pt_ad">
            <img src="{{ asset('assets/ad/5172142730687196526.gif') }}" class="pt_ad_img">
        </div>
    </div>
...
<div class="advertiseContent">
    <img src="{{ asset('assets/ad/10901667871545435373.gif') }}" class="Ad_img">
</div>
{{--Advertise Content--}}
